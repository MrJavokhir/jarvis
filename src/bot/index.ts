...
const HELP_TEXT = [
  ...
  "",
  "<b>🎤 Ovozli xabar</b> — erkin gapirsangiz bo'ladi, o'zim tushunaman.",
  "",
  "<b>💬 Matn</b> — quyidagi shakllarda yozing:",
  ...
  "",
  "<b>Sana:</b> <i>bugun, ertaga, indinga, hafta kunlari, 10.09, 15-sentabr, 3 kundan keyin</i>",
  "<b>Vaqt:</b> <i>15:00, soat 3 da, ertalab, tushda, kechqurun, 2 soatdan keyin</i>",
  "<b>Takror:</b> <i>har kuni, har hafta, har dushanba, har oy, har yili</i>",
  "",
  "Soat aytilmasa 09:00 qo'yaman — kartochkadan o'zgartirsangiz bo'ladi.",
  "",
  "<b>Buyruqlar:</b>",
  "/start — boshlash",
